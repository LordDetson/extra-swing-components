...
public final class ExceptionDialog extends JDialog {
    ...
    private ExceptionDialog(Throwable throwable, Icon icon) {
    ...
    public static void display(Throwable throwable, Icon icon) {
        ExceptionDialog exceptionDialog = new ExceptionDialog(throwable, icon);
