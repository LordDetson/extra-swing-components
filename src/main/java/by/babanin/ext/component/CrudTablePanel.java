...
import by.babanin.ext.component.form.ComponentForm;
import by.babanin.ext.component.form.FormDialog;
...
public abstract class CrudTablePanel<C> extends JPanel
    ...
    private final transient Representation<C> representation;
    ...
    protected CrudTablePanel(Class<C> componentClass, FormRowFactory formRowFactory, CrudStyle crudStyle) {
        this.representation = RepresentationRegister.get(componentClass);
    ...
    protected TableModel<C> createTableModel(Representation<C> representation, List<ReportField> fields) {
    ...
    public void load() {
        Task<List<C>> task = createLoadTask();
    ...
    protected abstract Task<List<C>> createLoadTask();
    ...
    private void showEditDialog() {
        C selectedComponent = getSelectedComponent()
                .orElseThrow(() -> new UIException("Can't open edit dialog because component is not selected"));
    ...
    private void showDeleteConfirmDialog() {
        ...
        if(result == JOptionPane.YES_OPTION) {
            Task<List<C>> task = createDeleteTask(getSelectedComponents());
    ...
    protected abstract Task<List<C>> createDeleteTask(List<C> selectedComponents);

    public Representation<C> getRepresentation() {
