...
import by.babanin.ext.component.statusbar.LogStatusBarItem;
import by.babanin.ext.component.statusbar.StatusBar;
...
public class ComponentForm<C> extends JPanel {
    ...
    private List<? extends FormRow<?>> createFormRows() {
        ...
        return representation.getFields().stream()
    ...
    public Representation<C> getComponentRepresentation() {
